...
bool OpeningAnimation::init()
{
    ...
    //
    light->runAction(Sequence::create(EaseSineOut::create(ScaleTo::create(0.5f,800/64.0f,0.01)),RemoveSelf::create(), NULL));
    ...
    boardNode->runAction(Sequence::create(DelayTime::create(0.5),EaseSineOut::create(ScaleTo::create(0.7,1,0.25)),CallFunc::create([&](){
